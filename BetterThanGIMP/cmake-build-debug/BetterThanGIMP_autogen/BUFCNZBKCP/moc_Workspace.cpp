...
#include "../../../src/display/workspace/Workspace.h"
...
QT_MOC_LITERAL(1, 10, 17), // "updateWindowImage"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 6) // "string"

    },
    "Workspace\0updateWindowImage\0\0string"
};
...
void Workspace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Workspace::updateWindowImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Workspace::updateWindowImage(QString _t1)
{
